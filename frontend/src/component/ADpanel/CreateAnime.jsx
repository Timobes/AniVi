...
export function CreateAnime() {
    ...
    const onSubmit = (data) => {
        createAnime({anime_title_rus: data.anime_title_rus, anime_title_eng: data.anime_title_eng, anime_title_jap: data.anime_title_jap, description: data.description, years: data.years, poster_url: data.poster_url}, {headers: {"token": token}})
            .then((data) => {
                console.log(data)
            })
